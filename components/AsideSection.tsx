      ...
      <aside className='hidden lg:flex  w-[22%] h-[calc(100vh-1rem)] bg-customPurple text-white absolute top-2 bottom-2 right-2 overflow-hidden  flex-col items-center justify-between pt-5 pb-16 px-2'>
          ...
          <div className="flex flex-col items-center gap-8">
              ...
              <div className="w-full flex justify-center items-center">
                <button className="px-6 py-[6px] rounded-2xl hover:bg-background bg-customPurpleBtn transition ease-in-out duration-300">Algorithms</button>
                <button className="px-6 py-[6px] rounded-2xl hover:bg-background active:bg-customPurpleBtn transition ease-in-out duration-300">Courses</button>
              </div>
